...
[security advisory form](https://github.com/Barnett-Studios/baseplate/security/advisories/new).
This lets us investigate and ship a fix before the issue is public.

Please include:

- a description of the vulnerability and its impact,
- the `baseplate` version and how it was built or installed,
...
`baseplate` is a component of the [Barnett Studios agentic-harness
