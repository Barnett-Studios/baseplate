...
[security advisory form](https://github.com/Barnett-Studios/dotclaude-support/security/advisories/new).
This lets us investigate and ship a fix before the issue is public.

Please include:

- a description of the vulnerability and its impact,
- the `dotclaude-support` version and how it was built or installed,
...
`dotclaude-support` is a component of the [Barnett Studios agentic-harness
